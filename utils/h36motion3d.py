...
class Datasets(Dataset):
    ...
    def __init__(self, opt, actions=None, split=0):
        ...
        # self.path_to_data = "C:/Users/river/Desktop/paper/one/MANet/datasets/h3.6m/dataset"
        self.split = split
            ...
            for action_idx in np.arange(len(acts)):
                ...
                if self.split <= 1:
                    for subact in [1, 2]:  # subactions
                        ...
                        the_sequence = torch.from_numpy(the_sequence).float().to(self.dev)
                        # remove global rotation and translation
                        the_sequence[:, 0:6] = 0
                        p3d = data_utils.expmap2xyz_torch(the_sequence, dev=self.dev)
                    ...
                    the_seq1 = torch.from_numpy(the_sequence1).float().to(self.dev)
                    the_seq1[:, 0:6] = 0
                    ...
                    the_seq2 = torch.from_numpy(the_sequence2).float().to(self.dev)
                    the_seq2[:, 0:6] = 0
